...
export default function SideBar () {
    ...
    return (
        <nav className="flex flex-col bg-teal-900 p-6 top-0 bottom-0 h-full min-h-screen w-[200px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300">
            <div>
               {/* {activeMenu && (<> */}
