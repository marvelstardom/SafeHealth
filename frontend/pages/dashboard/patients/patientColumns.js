...
export const patientColumns = [
    ...
    },
    {
        ...
        cell: row => (
            <div>
                {/* EDIT */}
            <button onClick={() => alert('I am number' + row.id + ' '+ row.firstName + ' ' + row.lastName)}>
            ...
            {/* VIEW */}
            <Link href={{pathname: '/dashboard/patients/patient/', query: {id: row.id}}} >
            <button>
