...
// import mockData from "../doctorsData/doctordata.json"
...
export const DoctorsTable = () => {
  ...
  return (
    ...
    <div className="flex flex-row justify-between">
        ...
        <div className='flex self-end'><input type="search" className="pl-4 bg-white border rounded-lg py-2 font-normal" placeholder="Find Doctor"></input></div>
        ...
        <div>
            ...
            className="py-2 px-4 font-normal bg-white border rounded-lg"/>
        </div>
        <Link href=''>
            <button 
    ...
    <DataTable className='w-full max-w-fit' columns={docColumns} data={doctorRecords} selectableRows fixedHeader pagination></DataTable></div>
